...
class ParallelPATHAttentionFunction(torch.autograd.Function):
    ...
    @input_guard
    @autocast_custom_fwd
    def forward(ctx, q, k, v, w, beta, g, scale, cu_seqlens, use_cache=False, decay_table=None):
        ...
        q=torch.ones(16, 512, 12, 64).cuda()
        ...
        # if use_decay:
        #     ctx.save_for_backward(q, k, v, w, g_cumsum, o, beta, L, A, decay_table)
        # else:
    ...
    def backward(ctx, do, dk_new):
        ...
        # if ctx.use_decay:
            # q, k, v, w, g_cumsum, o, beta, L, A, decay_table = saved
            # decay_tail = decay_table[:, :BS].contiguous()
        # else:
        q, k, v, w, g_cumsum, o, beta, L, A = saved
...
def parallel_path_attn(
    ...
    o, k_cache = ParallelPATHAttentionFunction.apply(q, k, v, w, beta, g, scale, cu_seqlens, use_cache, decay_table)
    return o, k_cache
